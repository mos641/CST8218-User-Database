...
import com.mycompany.lab04.userdb.util.JsfUtil;
import com.mycompany.lab04.userdb.util.PaginationHelper;
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private com.mycompany.lab04.userdb.AppUserFacade ejbFacade;
